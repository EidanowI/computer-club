    ...
    <div className={styles.main_sec_conteiner}>
      <div className={styles.main_sec_main}>
        <div className={styles.main_sec_label_cont}>
          ...
          <button className={styles.main_sec_main_morebtn} onClick={() => handleNavClick("info")}>УЗНАТЬ БОЛЬШЕ</button>
        </div>
      </div>
      ...
      <div className={styles.main_sec_devices}>
        ...
        <button className={styles.main_sec_devices_morebtn} onClick={() => handleNavClick("devices")}>Смотреть все</button>
      </div>
      <div className={styles.main_sec_compets}>
        ...
        <button className={styles.main_sec_compets_morebtn} onClick={() => handleNavClick("compets")}>Ближайшие даты</button>
      </div>
      <div className={styles.main_sec_contacts}>
        ...
        <button className={styles.main_sec_contacts_morebtn} onClick={() => handleNavClick("contscts")}>Смотреть все</button>
      </div>
    </div>
  </>);
}